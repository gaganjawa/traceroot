...
### TR-015 — Logs Tool
Implement structured log querying with filters such as service, level,
and text matching.
...
Define the stable data contracts shared by the dataset, evidence tools,
RAG pipeline, investigation agent, and evaluation framework.